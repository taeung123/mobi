                    ...
                    <div class="recent-work-wrap">
                        ...
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <h3><a href="chitietgoicuoc/{{$gc['id']}}">{{$gc['Ten']}}</a> </h3>
                                <p>{{$gc['TomTat']}}</p>
                                <a class="preview" href="chitietgoicuoc/{{$gc['id']}}" rel="prettyPhoto"><i class="fa fa-eye"></i> Chi tiết</a>
                            </div> 
                        </div>
                    </div>
                </div>  
                ...
                <div class="tinkhuyenmai">
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            <a href="tintuc/{{$tt->id}}"><i class="fa fa-bullhorn"></a></i>
                            <h2>{{$tt['TieuDe']}}</h2>
                            <h3>{{$tt['TomTat']}}</h3>
                        </div>
                    </div><!--/.col-md-4-->
